...
// ================= Component =================
export default function MeetingModify() {
  const { projectId, id } = useParams(); // id = meetingId
    ...
    const fetchMeeting = async () => {
      try {
        ...
        if (res.data) {
          ...
          setFormData({
            meetingDate: formatDate(res.data.meetingDate),
            host: res.data.author || "",
            attendees: res.data.attend ? res.data.attend.split(",") : [],
  ...
  const handleAttendeeChange = (e) => {
    ...
    setFormData({
      ...formData,
      attendees: checked
        ? [...formData.attendees, value]
        : formData.attendees.filter((a) => a !== value),
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `/project/organization/${projectId}/meeting/api/modify/${id}`,
        payload,
        { withCredentials: true }
      );
